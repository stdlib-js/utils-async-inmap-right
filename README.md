...
```javascript
import inmapRightAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-inmap-right@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-inmap-right@v0.1.0-deno/mod.js';
```
